...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 bg-transparent border-light">
            <div class="card bg-transparent border-light">
                <div class="card-header bg-transparent border-light text-light">{{ __('Registro') }}</div>
                ...
                <div class="card-body fondo-app text-light">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control bg-transparent text-light @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control bg-transparent text-light @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
